...
const pageButtonBase = 'grid size-9 appearance-none place-items-center rounded-lg text-sm font-medium outline-none transition-colors duration-150 focus-visible:ring-2 focus-visible:ring-[var(--color-focus)]/25 disabled:cursor-not-allowed disabled:opacity-40';
        ...
        : (
          <button
            ...
            className={cn(
              pageButtonBase,
              item === page
                ? 'border border-[var(--color-brand)] bg-[var(--color-brand)] text-[var(--color-brand-foreground)]'
