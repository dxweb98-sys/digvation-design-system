...
export function DRangeDatePicker({ label, placeholder = 'Pilih periode', value, size = 'md', onChange, error, hint, disabled = false, clearable = true, containerClassName, scrollBehavior = 'reposition' }: RangeDatePickerProps) {
  ...
  return <div className={cn('flex min-w-0 flex-col gap-1.5', containerClassName)}>
    ...
    <DDropdown placement="bottom-end" contentRole="dialog" scrollBehavior={scrollBehavior} trigger={({ open }) => <div className="relative">
